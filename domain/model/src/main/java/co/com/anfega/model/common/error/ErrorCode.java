...
public enum ErrorCode {
    ...
    INVALID_JSON("FRQ_VAL_0002", "El body debe tener un JSON válido", 400),
    ...
    INTERNAL_ERROR("FRQ_INT_0001", "Ocurrió un error inesperado", 500),
    DATABASE_ERROR("FRQ_INT_0002", "Falló la operación en la base de datos", 500),
    PERSISTENCE_UNAVAILABLE("FRQ_INT_0003", "La persistencia no está disponible temporalmente", 503);
